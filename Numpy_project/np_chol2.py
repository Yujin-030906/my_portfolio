...
try:
    ...
    ldl_m = ldl_df[(ldl_df['지역'] == '전국') & (ldl_df['성별'] == '남성')].copy()
    hdl_m = hdl_df[(hdl_df['지역'] == '전국') & (hdl_df['성별'] == '남성')].copy()
    ...
    plt.title('한국인 남성 연령별 LHR 지수 추세 분석', fontsize=20)
    ...
    print(f"성공적으로 분석되었습니다. 45세 남성 예상 LHR: {model(45):.2f}")
